...
- Generating random $t$ values.
- Computing the residual $f(t)$.
- Estimating $t^*$ statistically.
...
$$t_{\text{max}} \approx \frac{\|\mathbf{r}_0\|}{s_\beta - \|\mathbf{v}_{\alpha 0}\|} + \frac{\|\mathbf{a}_\alpha\| t_{\text{max}}^2}{2 s_\beta}$$ (iteratively solved).
